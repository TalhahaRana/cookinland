...
export default function Component() {
  ...
  const menu = [
    ...
    {
      id: 6,
      name: "Assorted Brownies - 6 pcs",
      description: "A variety of rich and fudgy brownies in every bite.",
      price: 18.99,
    ...
    {
      id: 7,
      name: "Choco Divine Brownies - 6 pcs",
    ...
    {
      id: 8,
      name: "Classical Fudge Brownies - 6 pcs",
      description: "Classic fudge brownies with a deep, rich chocolate flavor.",
      price: 900,
    ...
    },
    {
      ...
      description: "Delicious brownies topped with Lotus Biscoff for an extra crunch.",
      price: 800,
    ...
    {
      id: 10,
      name: "Nutella Brownies - 6 pcs",
      description: "Decadent brownies filled with creamy Nutella.",
      price: 1500,
